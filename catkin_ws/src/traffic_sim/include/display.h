...
public:
  ...
  /**
   * Set the color of the cars as red.
   */
  ...
  /**
   * Change the color of a specific car.
   */
  ...
  /**
   * draw the rectangle with center and shape
   */
  static void rectangle(Vector2f pos, int length, int width, Color color, Vector2f* dir = NULL, int filled = 1, int thickness = 0) {
    ...
    // render the rectangle in the simulation window
  ...
  /**
   * draw the rectangle with corner points
   */
