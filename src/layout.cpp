...
int Layout::getWidth() { return int(data.get("size").get(0).get<double>()); }

int Layout::getHeight() { return int(data.get("size").get(1).get<double>()); }

int Layout::getStartX() { return int(data.get("host").get(0).get<double>()); }
...
std::string Layout::getHostDir() { return data.get("hostDir").to_str(); }
