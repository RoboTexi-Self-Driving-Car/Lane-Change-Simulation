...
static UMAP<string, pff> direction = {
    {"east", {1, 0}},       {"west", {-1, 0}},      {"south", {1, 0}},
    {"north", {-1, 0}},     {"northeast", {1, 1}},  {"northwest", {-1, 1}},
...
//    UMAP<string, int>
//    Intention_To_Index{{"cooperative",0},{"normal",1},{"aggressive",2}};
//
//    //to produce the permuation of a list of states
//    vector<vector<string>> product(const vector<string>& states, int repeat =
//    3) {
...
//        void initializeUniformly(const Model& model,const vector<string>&
//        intentions); void initializeParticles(); void observe(const Model&
//        model); Counter<vector<string>> getBelief(); vector<string> sample(
//        Counter<vector<string>>& counter); pff
//        getMeanStandard(queue<float>&history, const string& intention);
//    };
//
//    void JointParticles::initializeUniformly(const Model& model, const
...
//        std::mt19937 g(rd());
//        vector<vector<string>> jointstates = product(legalIntentions,
//        numAgents); std::shuffle (jointstates.begin(), jointstates.end(), g);
//        int n = numParticles;
...
//    }
//
//    vector<string> JointParticles::sample(Counter<vector<string>>&
//    distribution) {
//        if (distribution.sum() != 1) distribution.normalize();
//        std::vector<std::pair<vector<string>, float>>
//        elems(distribution.begin(), distribution.end());
//        std::sort(elems.begin(), elems.end(),
//                  [](const std::pair<vector<string>, float>& a, const
//                  std::pair<vector<string>, float>& b)->bool{return
//                  a.second<b.second;});
...
//        return keys[i];
//    }
//    pff  JointParticles::getMeanStandard(queue<float>&history, const string&
//    intention) {
