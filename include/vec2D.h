...
class Vector2d {
 public:
  ...
  bool Intersect(const Vector2d<T>&, const Vector2d<T>&, const Vector2d<T>&,
                 const Vector2d<T>&);

  // Return the point where two lines intersect.
  Vector2d<T> get_Intersect(const Vector2d<T>&, const Vector2d<T>&,
                            const Vector2d<T>&, const Vector2d<T>&);
  ...
  Vector2d<T> get_reflection() { return Vector2d(-x, -y); }
...
template <class T>
bool Vector2d<T>::Intersect(const Vector2d<T>& aa, const Vector2d<T>& ab,
...
template <class T>
Vector2d<T> Vector2d<T>::get_Intersect(const Vector2d<T>& aa,
                                       const Vector2d<T>& ab,
                                       const Vector2d<T>& ba,
                                       const Vector2d<T>& bb) {
